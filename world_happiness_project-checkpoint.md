   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/var/folders/9t/64tm8pcn4vjg_vv49fm471rw0000gn/T/ipykernel_24613/3693299084.py:7: UserWarning: FixedFormatter should only be used together with FixedLocator\n",
      "  ax[0].set_xticklabels(top,rotation=45,ha='right')\n",
      "/var/folders/9t/64tm8pcn4vjg_vv49fm471rw0000gn/T/ipykernel_24613/3693299084.py:18: UserWarning: FixedFormatter should only be used together with FixedLocator\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "THe MAE of the KNN_regression is: 0.39827999999999986\n",
      "THe MSE of the KNN_regression is: 0.3418909866666665\n",
      "THe R^2 of the KNN_regression is: 0.6773677293921817\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "THe MAE of the Decision_Tree is: 0.6589666666666666\n",
      "THe MSE of the Decision_Tree is: 0.6369110333333333\n",
      "THe R^2 of the Decision_Tree is: 0.39896615917561495\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "1          LINEAR_REGRESSOR             0.380402            0.240183   \n",
       "2  SUPPORT_VECTOR_REGRESSOR             0.415027            0.381574   \n",
       "3   DECISION_TREE_REGRESSOR             0.658967            0.636911   \n",
       "\n",
       "   R Squared Error  \n",
       "0         0.677368  \n",
       "1         0.773347  \n",
   ...
   "outputs": [
    {
     ...
     "traceback": [
      "\u001b[0;31m---------------------------------------------------------------------------\u001b[0m",
      "\u001b[0;31mTypeError\u001b[0m                                 Traceback (most recent call last)",
      "\u001b[0;32m/var/folders/9t/64tm8pcn4vjg_vv49fm471rw0000gn/T/ipykernel_24613/1305742492.py\u001b[0m in \u001b[0;36m<module>\u001b[0;34m\u001b[0m\n\u001b[1;32m      2\u001b[0m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mfigure\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0mfigsize\u001b[0m\u001b[0;34m=\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;36m4\u001b[0m\u001b[0;34m,\u001b[0m\u001b[0;36m4\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      3\u001b[0m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mscatter\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0my_test\u001b[0m\u001b[0;34m,\u001b[0m\u001b[0mpredictions_3\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0;32m----> 4\u001b[0;31m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mtitle\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"Actaul happiness score vs predicted happiness scores\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0m\u001b[1;32m      5\u001b[0m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mxlabel\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"Actual happiness scores\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      6\u001b[0m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mylabel\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"Predicted happiness scores\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n",
      "\u001b[0;31mTypeError\u001b[0m: 'str' object is not callable"
     ]
    },
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
       "<Figure size 288x288 with 1 Axes>"
      ]
     },
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "THe MAE of the Random_forest is: 0.4860375\n",
      "THe MSE of the Random_forest is: 0.3703432859375001\n",
      "THe R^2 of the Random_forest is: 0.6505181478712975\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "traceback": [
      "\u001b[0;31m---------------------------------------------------------------------------\u001b[0m",
      "\u001b[0;31mTypeError\u001b[0m                                 Traceback (most recent call last)",
      "\u001b[0;32m/var/folders/9t/64tm8pcn4vjg_vv49fm471rw0000gn/T/ipykernel_24613/1517099451.py\u001b[0m in \u001b[0;36m<module>\u001b[0;34m\u001b[0m\n\u001b[1;32m      2\u001b[0m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mfigure\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0mfigsize\u001b[0m\u001b[0;34m=\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;36m4\u001b[0m\u001b[0;34m,\u001b[0m\u001b[0;36m4\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      3\u001b[0m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mscatter\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0my_test\u001b[0m\u001b[0;34m,\u001b[0m\u001b[0mpredictions_4\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0;32m----> 4\u001b[0;31m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mtitle\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"Actual happiness score vs predicted happiness scores\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[0m\u001b[1;32m      5\u001b[0m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mxlabel\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"Actual happiness scores\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n\u001b[1;32m      6\u001b[0m \u001b[0mplt\u001b[0m\u001b[0;34m.\u001b[0m\u001b[0mylabel\u001b[0m\u001b[0;34m(\u001b[0m\u001b[0;34m\"Predicted happiness scores\"\u001b[0m\u001b[0;34m)\u001b[0m\u001b[0;34m\u001b[0m\u001b[0;34m\u001b[0m\u001b[0m\n",
      "\u001b[0;31mTypeError\u001b[0m: 'str' object is not callable"
     ]
    },
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
       "<Figure size 288x288 with 1 Axes>"
      ]
     },
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "2  SUPPORT_VECTOR_REGRESSOR             0.415027            0.381574   \n",
       "3   DECISION_TREE_REGRESSOR             0.658967            0.636911   \n",
       "4   RANDOM_FOREST_REGRESSOR             0.486038            0.370343   \n",
       "\n",
       "   R Squared Error  \n",
       "0         0.677368  \n",
       "1         0.773347  \n",
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       "<style type=\"text/css\">\n",
       "#T_bfb1e_row0_col0, #T_bfb1e_row1_col1, #T_bfb1e_row2_col2, #T_bfb1e_row3_col3, #T_bfb1e_row4_col4, #T_bfb1e_row5_col5, #T_bfb1e_row6_col6, #T_bfb1e_row7_col7 {\n",
       ...
       "  color: #f1f1f1;\n",
       "}\n",
       "#T_bfb1e_row0_col7, #T_bfb1e_row4_col0 {\n",
       ...
       "  color: #f1f1f1;\n",
       "}\n",
       "#T_bfb1e_row2_col0, #T_bfb1e_row3_col7 {\n",
       ...
       "  color: #000000;\n",
       "}\n",
       "#T_bfb1e_row2_col4, #T_bfb1e_row4_col2 {\n",
       ...
       "  color: #000000;\n",
       "}\n",
       "#T_bfb1e_row4_col6, #T_bfb1e_row6_col3 {\n",
       ...
       "  color: #000000;\n",
       "}\n",
       "#T_bfb1e_row5_col2, #T_bfb1e_row5_col3 {\n",
       ...
       "  color: #000000;\n",
       "}\n",
       "#T_bfb1e_row5_col7, #T_bfb1e_row7_col0, #T_bfb1e_row7_col1, #T_bfb1e_row7_col2, #T_bfb1e_row7_col3, #T_bfb1e_row7_col4, #T_bfb1e_row7_col5, #T_bfb1e_row7_col6 {\n",
       ...
       "  <tbody>\n",
       "    <tr>\n",
       "      <th id=\"T_bfb1e_level0_row0\" class=\"row_heading level0 row0\" >year</th>\n",
       "      <td id=\"T_bfb1e_row0_col0\" class=\"data row0 col0\" >1.000000</td>\n",
       "      <td id=\"T_bfb1e_row0_col1\" class=\"data row0 col1\" >0.064171</td>\n",
       "      <td id=\"T_bfb1e_row0_col2\" class=\"data row0 col2\" >0.090051</td>\n",
       "      <td id=\"T_bfb1e_row0_col3\" class=\"data row0 col3\" >0.013482</td>\n",
       "      <td id=\"T_bfb1e_row0_col4\" class=\"data row0 col4\" >0.185613</td>\n",
       "      <td id=\"T_bfb1e_row0_col5\" class=\"data row0 col5\" >0.264187</td>\n",
       "      <td id=\"T_bfb1e_row0_col6\" class=\"data row0 col6\" >-0.041746</td>\n",
       "      <td id=\"T_bfb1e_row0_col7\" class=\"data row0 col7\" >-0.100054</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th id=\"T_bfb1e_level0_row1\" class=\"row_heading level0 row1\" >Ladder score</th>\n",
       "      <td id=\"T_bfb1e_row1_col0\" class=\"data row1 col0\" >0.064171</td>\n",
       "      <td id=\"T_bfb1e_row1_col1\" class=\"data row1 col1\" >1.000000</td>\n",
       "      <td id=\"T_bfb1e_row1_col2\" class=\"data row1 col2\" >0.792625</td>\n",
       "      <td id=\"T_bfb1e_row1_col3\" class=\"data row1 col3\" >0.716365</td>\n",
       "      <td id=\"T_bfb1e_row1_col4\" class=\"data row1 col4\" >0.755120</td>\n",
       "      <td id=\"T_bfb1e_row1_col5\" class=\"data row1 col5\" >0.528963</td>\n",
       "      <td id=\"T_bfb1e_row1_col6\" class=\"data row1 col6\" >0.167975</td>\n",
       "      <td id=\"T_bfb1e_row1_col7\" class=\"data row1 col7\" >-0.446527</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th id=\"T_bfb1e_level0_row2\" class=\"row_heading level0 row2\" >Logged GDP per capita</th>\n",
       "      <td id=\"T_bfb1e_row2_col0\" class=\"data row2 col0\" >0.090051</td>\n",
       "      <td id=\"T_bfb1e_row2_col1\" class=\"data row2 col1\" >0.792625</td>\n",
       "      <td id=\"T_bfb1e_row2_col2\" class=\"data row2 col2\" >1.000000</td>\n",
       "      <td id=\"T_bfb1e_row2_col3\" class=\"data row2 col3\" >0.711879</td>\n",
       "      <td id=\"T_bfb1e_row2_col4\" class=\"data row2 col4\" >0.859453</td>\n",
       "      <td id=\"T_bfb1e_row2_col5\" class=\"data row2 col5\" >0.358373</td>\n",
       "      <td id=\"T_bfb1e_row2_col6\" class=\"data row2 col6\" >-0.038199</td>\n",
       "      <td id=\"T_bfb1e_row2_col7\" class=\"data row2 col7\" >-0.343938</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th id=\"T_bfb1e_level0_row3\" class=\"row_heading level0 row3\" >Social support</th>\n",
       "      <td id=\"T_bfb1e_row3_col0\" class=\"data row3 col0\" >0.013482</td>\n",
       "      <td id=\"T_bfb1e_row3_col1\" class=\"data row3 col1\" >0.716365</td>\n",
       "      <td id=\"T_bfb1e_row3_col2\" class=\"data row3 col2\" >0.711879</td>\n",
       "      <td id=\"T_bfb1e_row3_col3\" class=\"data row3 col3\" >1.000000</td>\n",
       "      <td id=\"T_bfb1e_row3_col4\" class=\"data row3 col4\" >0.623813</td>\n",
       "      <td id=\"T_bfb1e_row3_col5\" class=\"data row3 col5\" >0.414582</td>\n",
       "      <td id=\"T_bfb1e_row3_col6\" class=\"data row3 col6\" >0.043773</td>\n",
       "      <td id=\"T_bfb1e_row3_col7\" class=\"data row3 col7\" >-0.225320</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th id=\"T_bfb1e_level0_row4\" class=\"row_heading level0 row4\" >Healthy life expectancy</th>\n",
       "      <td id=\"T_bfb1e_row4_col0\" class=\"data row4 col0\" >0.185613</td>\n",
       "      <td id=\"T_bfb1e_row4_col1\" class=\"data row4 col1\" >0.755120</td>\n",
       "      <td id=\"T_bfb1e_row4_col2\" class=\"data row4 col2\" >0.859453</td>\n",
       "      <td id=\"T_bfb1e_row4_col3\" class=\"data row4 col3\" >0.623813</td>\n",
       "      <td id=\"T_bfb1e_row4_col4\" class=\"data row4 col4\" >1.000000</td>\n",
       "      <td id=\"T_bfb1e_row4_col5\" class=\"data row4 col5\" >0.392673</td>\n",
       "      <td id=\"T_bfb1e_row4_col6\" class=\"data row4 col6\" >0.004725</td>\n",
       "      <td id=\"T_bfb1e_row4_col7\" class=\"data row4 col7\" >-0.338215</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th id=\"T_bfb1e_level0_row5\" class=\"row_heading level0 row5\" >Freedom to make life choices</th>\n",
       "      <td id=\"T_bfb1e_row5_col0\" class=\"data row5 col0\" >0.264187</td>\n",
       "      <td id=\"T_bfb1e_row5_col1\" class=\"data row5 col1\" >0.528963</td>\n",
       "      <td id=\"T_bfb1e_row5_col2\" class=\"data row5 col2\" >0.358373</td>\n",
       "      <td id=\"T_bfb1e_row5_col3\" class=\"data row5 col3\" >0.414582</td>\n",
       "      <td id=\"T_bfb1e_row5_col4\" class=\"data row5 col4\" >0.392673</td>\n",
       "      <td id=\"T_bfb1e_row5_col5\" class=\"data row5 col5\" >1.000000</td>\n",
       "      <td id=\"T_bfb1e_row5_col6\" class=\"data row5 col6\" >0.312524</td>\n",
       "      <td id=\"T_bfb1e_row5_col7\" class=\"data row5 col7\" >-0.482894</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th id=\"T_bfb1e_level0_row6\" class=\"row_heading level0 row6\" >Generosity</th>\n",
       "      <td id=\"T_bfb1e_row6_col0\" class=\"data row6 col0\" >-0.041746</td>\n",
       "      <td id=\"T_bfb1e_row6_col1\" class=\"data row6 col1\" >0.167975</td>\n",
       "      <td id=\"T_bfb1e_row6_col2\" class=\"data row6 col2\" >-0.038199</td>\n",
       "      <td id=\"T_bfb1e_row6_col3\" class=\"data row6 col3\" >0.043773</td>\n",
       "      <td id=\"T_bfb1e_row6_col4\" class=\"data row6 col4\" >0.004725</td>\n",
       "      <td id=\"T_bfb1e_row6_col5\" class=\"data row6 col5\" >0.312524</td>\n",
       "      <td id=\"T_bfb1e_row6_col6\" class=\"data row6 col6\" >1.000000</td>\n",
       "      <td id=\"T_bfb1e_row6_col7\" class=\"data row6 col7\" >-0.278394</td>\n",
       "    </tr>\n",
       "    <tr>\n",
       "      <th id=\"T_bfb1e_level0_row7\" class=\"row_heading level0 row7\" >Perceptions of corruption</th>\n",
       "      <td id=\"T_bfb1e_row7_col0\" class=\"data row7 col0\" >-0.100054</td>\n",
       "      <td id=\"T_bfb1e_row7_col1\" class=\"data row7 col1\" >-0.446527</td>\n",
       "      <td id=\"T_bfb1e_row7_col2\" class=\"data row7 col2\" >-0.343938</td>\n",
       "      <td id=\"T_bfb1e_row7_col3\" class=\"data row7 col3\" >-0.225320</td>\n",
       "      <td id=\"T_bfb1e_row7_col4\" class=\"data row7 col4\" >-0.338215</td>\n",
       "      <td id=\"T_bfb1e_row7_col5\" class=\"data row7 col5\" >-0.482894</td>\n",
       "      <td id=\"T_bfb1e_row7_col6\" class=\"data row7 col6\" >-0.278394</td>\n",
       "      <td id=\"T_bfb1e_row7_col7\" class=\"data row7 col7\" >1.000000</td>\n",
       "    </tr>\n",
       "  </tbody>\n",
       "</table>\n"
      ],
      "text/plain": [
       "<pandas.io.formats.style.Styler at 0x7f9240781d00>"
      ]
     },
     "execution_count": 81,
     "metadata": {},
